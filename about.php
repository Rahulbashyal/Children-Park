                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80" alt="Nepali Teacher 1" style="object-fit:cover;aspect-ratio:1/1;max-width:220px;max-height:220px;">
                            <div class="team-text">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=400&q=80" alt="Nepali Teacher 2" style="object-fit:cover;aspect-ratio:1/1;max-width:220px;max-height:220px;">
                            <div class="team-text">
                                <h3>Sita Gurung</h3>
                                <p>Science Teacher</p>
                                <div class="d-flex align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?auto=format&fit=crop&w=400&q=80" alt="Nepali Teacher 3" style="object-fit:cover;aspect-ratio:1/1;max-width:220px;max-height:220px;">
                            <div class="team-text">
                                <h3>Bikash Thapa</h3>
                                <p>English Teacher</p>
                                <div class="d-flex align-items-center">

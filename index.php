...
<head>
    ...
    <style>
        ...
        #logout-button {
            margin-left: 10px; /* Adjust margin to your preference */
        }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="popupModalLabel">Advertisement</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <?php if (!empty($currentImage)): ?>
                        <img src="<?php echo $currentImage; ?>" alt="Popup Ad" style="width: 100%;">
                    <?php else: ?>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="news.php" class="nav-item nav-link">Notice</a>
                ...
                <!-- <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                    <a href="dashboard.php" class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Dashboard</a>
                <?php elseif (isset($_SESSION['role']) && $_SESSION['role'] == 'teacher'): ?>
                    ...
                    <a href="teacher_dashboard.php" class="btn btn-danger" id="logout-button">Dashboard</a>
                <?php else: ?>
                    <a href="#" class="btn btn-primary rounded-pill px-3 d-none d-lg-block" data-bs-toggle="modal" data-bs-target="#loginModal">Login<i class="fa fa-arrow-right ms-3"></i></a>
                <?php endif; ?> -->
            </div>
        </nav>
        <!-- Navbar End -->
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="section-title text-center text-primary text-uppercase">Our Gallery</h2>
            <p class="text-muted">Explore the moments and events captured through our lens. Here's a glimpse of our activities and achievements.</p>
        </div>
        <div class="row g-4">
            <?php while ($row = $galleryResult->fetch_assoc()) { ?>
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item position-relative overflow-hidden">
                        <a href="<?php echo $row['image_url']; ?>" data-lightbox="gallery">
                            <img class="img-fluid w-100" src="<?php echo $row['image_url']; ?>" alt="<?php echo $row['title']; ?>">
                            <div class="gallery-hover">
                                <div class="gallery-hover-content">
                                    <h4 class="text-white"><?php echo $row['title']; ?></h4>
                                    <p class="text-white-50"><?php echo $row['description']; ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Children Park</a>, All Right Reserved. 
							
							
							Designed By <a class="border-bottom" href="https://abssoft.com">ABS Soft</a>
                            <br>Distributed By: <a class="border-bottom" href="https://ABS Soft.com" target="_blank">ABS Soft</a>
                        </div>
    ...
    <script>
// Display appropriate alert messages based on login result
// 
</script>
    <!-- Template Javascript -->
